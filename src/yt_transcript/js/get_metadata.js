(function() {
    ...
    var title = '', channel = '', lang = '', viewCount = '', publishDate = '', lengthSeconds = '';
    ...
    try { lengthSeconds = pr.videoDetails.lengthSeconds || ''; } catch(e) {}
    try {
    ...
    return JSON.stringify({title: title, channel: channel, language: lang, view_count: viewCount, publish_date: publishDate, duration_seconds: lengthSeconds});
})()
